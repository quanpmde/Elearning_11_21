...
public class TestController {
    ...
    public ApiResponse<TestResponse> getTestByUserIdAndExamId(@PathVariable int userId, @PathVariable int examId){
        return ApiResponse.<TestResponse>builder()
                .result(testService.getTestByUserIdAndExamId(userId,examId))
                .build();
    }
