...
public class TestService {
    ...
    public TestResponse createNewTest(TestRequest request) throws IOException {
        ...
        int examAttemptLimit = exam.getExamAttempt();  // Số lần làm bài cho phép
        int testAttempt = request.getTestAttempt();    // Số lần làm bài hiện tại
    ...
    public TestResponse getTestByUserIdAndExamId(int userId, int examId){
        // Tìm test theo userId và examId
        Test test = testRepository.findByUser_UserIdAndExam_ExamId(userId, examId)
    ...
    public TestResponse updateTest(int testId, TestRequest request) throws IOException{
        ...
        // Cập nhật các thuộc tính cho test hiện tại, nhưng không tăng testAttempt
        test.setQuestions(questions);
        test.setAnswers(answers);
